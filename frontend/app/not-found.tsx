...
export default function NotFound() {
  return (
    <div className="container-default min-h-[70vh] flex flex-col items-center justify-center py-16">
      <h1 className="text-4xl md:text-5xl font-bold text-primary dark:text-textLight mb-6">404</h1>
      <h2 className="text-2xl md:text-3xl font-bold mb-4">Page non trouvée</h2>
      <p className="text-center mb-8 max-w-md text-gray-600 dark:text-gray-300">

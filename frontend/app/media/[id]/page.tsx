      ...
      <>
        ...
        <div className="relative z-10 min-h-screen py-8">
          <div className="container mx-auto px-4">
            {/* Bouton retour sans transitions */}
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-offwhite font-bold text-lg shadow-md hover:bg-accent hover:text-dark hover:shadow-lg border-2 border-transparent hover:border-dark mb-6"
              role="button"
            ...
            {/* Contenu principal avec fond semi-transparent et effet de flou */}
            <div className="relative bg-white/80 dark:bg-gray-800/80 p-6 rounded-xl shadow-lg backdrop-blur-md">
              <div className="md:grid md:grid-cols-3 md:gap-8">
                {/* Poster du média */}
                <div className="mb-6 md:mb-0">
                  <div className="relative max-w-[300px] mx-auto md:mx-0 aspect-[2/3] rounded-xl overflow-hidden shadow-md hover:shadow-xl">
                    <Image
                ...
                <div className="md:col-span-2">
                  ...
                  {/* CTA sans transitions */}
                  <div className="mt-8">
                    <button 
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-offwhite font-bold text-lg shadow-md hover:bg-accent hover:text-dark hover:shadow-lg border-2 border-transparent hover:border-dark"
                      role="button"
